...
class DatabaseManager {
    ...
    async insertSampleData() {
        ...
        await this.run(`INSERT INTO locations (name, description, capacity, location_type) VALUES 
        ...
        await this.run(`INSERT INTO users (username, password_hash, email, full_name, role, department_id, email_verified) VALUES 
            ('admin', ?, 'admin@scheduling.com', 'مدير النظام', 'admin', 1, 1)`, [adminPasswordHash]);

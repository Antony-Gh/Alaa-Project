...
async function testAllFeatures() {
    ...
    try {
        ...
        const departmentsResponse = await axios.get(`${BASE_URL}/appointments/departments`);
        console.log('✅ Departments loaded:', departmentsResponse.data.data.length, 'departments');
        
        // Test 3: Get Locations
        console.log('\n3️⃣ Testing Locations...');
        const locationsResponse = await axios.get(`${BASE_URL}/appointments/locations`);
        console.log('✅ Locations loaded:', locationsResponse.data.data.length, 'locations');
        ...
        console.log('   Total appointments:', statsResponse.data.data.overview.total);
        ...
        console.log('   Total appointments:', analyticsResponse.data.data.overview.total);
        ...
        const preferencesResponse = await axios.get(`${BASE_URL}/notifications/preferences`, {
            headers: { Authorization: `Bearer ${authToken}` }
        });
        ...
        const userStatsResponse = await axios.get(`${BASE_URL}/users/stats/overview`, {
            headers: { Authorization: `Bearer ${authToken}` }
        });
        ...
        console.log('   Employee users:', userStatsResponse.data.data.employee_count);
